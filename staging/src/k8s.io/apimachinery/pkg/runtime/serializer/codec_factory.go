...
func newSerializersForScheme(scheme *runtime.Scheme, mf json.MetaFactory, options CodecFactoryOptions) []runtime.SerializerInfo {
	jsonSerializer := json.NewSerializerWithOptions(
		mf, scheme, scheme,
		json.SerializerOptions{Yaml: false, Pretty: false, Strict: options.Strict, StreamingCollections: options.StreamingCollectionsEncoderToJSON},
	)
	jsonSerializerType := runtime.SerializerInfo{
		...
		StrictSerializer: json.NewSerializerWithOptions(
			mf, scheme, scheme,
			json.SerializerOptions{Yaml: false, Pretty: false, Strict: true, StreamingCollections: options.StreamingCollectionsEncoderToJSON},
		),
...
type CodecFactoryOptions struct {
	...
	StreamingCollectionsEncoderToJSON bool
...
func WithStreamingCollectionEcoderToJson() CodecFactoryOptionsMutator {
	return func(options *CodecFactoryOptions) {
		options.StreamingCollectionsEncoderToJSON = true
	}
}
