...
func TestStalenessMetrics(t *testing.T) {
	...
	testedMetrics := []string{
		...
		"controller_manager_pod_watch_delay_seconds",
	}
	...
	testCases := []struct {
	...
	}{
		{
			...
			want: `
# HELP controller_manager_pod_watch_delay_seconds [ALPHA] Pod watch delay seconds
# TYPE controller_manager_pod_watch_delay_seconds gauge
controller_manager_pod_watch_delay_seconds{group="",resource="pods"} 3.5
...
# HELP controller_manager_pod_watch_delay_seconds [ALPHA] Pod watch delay seconds
# TYPE controller_manager_pod_watch_delay_seconds gauge
controller_manager_pod_watch_delay_seconds{group="",resource="pods"} 0.5
# HELP controller_manager_watch_delay_seconds [ALPHA] Watch delay seconds, for now calculated only for pods
# TYPE controller_manager_watch_delay_seconds histogram
...
# HELP controller_manager_pod_watch_delay_seconds [ALPHA] Pod watch delay seconds
# TYPE controller_manager_pod_watch_delay_seconds gauge
controller_manager_pod_watch_delay_seconds{group="",resource="pods"} 500
# HELP controller_manager_watch_delay_seconds [ALPHA] Watch delay seconds, for now calculated only for pods
# TYPE controller_manager_watch_delay_seconds histogram
controller_manager_watch_delay_seconds_bucket{group="",resource="pods",le="2.5"} 0
