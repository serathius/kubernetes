...
function gke-configure-npd-custom-plugins {
  ...
  GKE_NPD_CUSTOM_PLUGINS_CONFIG+=",${config_dir}/swap-monitor.json,${config_dir}/fs-readonly-monitor.json,${config_dir}/kubelet-monitor.json,${config_dir}/resource-monitor.json"
}
