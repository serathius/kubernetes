...
# This script lints each shell script under gke/ by `shellcheck`.
# Usage: `gke/hack/verify-shellcheck.sh`.
# This is forked from `hack/verify-shellcheck.sh`.
